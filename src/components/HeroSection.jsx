  ...
  return (
    <section
      ...
      >
       ...
       <img src="/images/HeroBG.jpg" className="absolute inset-0 w-full h-full object-cover" alt="background" />
       <div className="absolute inset-0 bg-black/40 z-10 md:bg-black/10"></div>
       
       <nav className="relative z-20 h-20 flex justify-between items-center px-8 md:px-12 bg-black/25 backdrop-blur-md">
       ...
       >
         ...
         <div className="flex flex-col items-center gap-3 sm:flex-row md:w-[40vw] md:[&>*:first-child]:flex-[1] md:[&>*:last-child]:flex-[3] sm:[&>*]:w-auto">
    	  	<select
    	  		name='OS'
    	  		id=''
    	  		value={platform}
